        ...
        <div className="row g-0 mt-5">
          ...
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <a className="button main-color btn-lg text-white" href="#">
                Sign Up
              </a>
            </div>
          </div>
        ...
        <div className="row g-0">
          <div className="col-4 col-md-4 container d-flex justify-content-center align-items-center">
            <div className="ml-2">
              ...
              <p className="lead">
                Try to check it daily as our collection is always changin! We
                work nonstop to provide the best accurate book selection
